...
ENV PATH=/opt/rh/devtoolset-7/root/usr/bin${PATH:+:${PATH}} \
    ...
    LD_LIBRARY_PATH=/opt/rh/devtoolset-7/root/usr/lib64:/opt/rh/devtoolset-7/root/usr/lib/gcc/x86_64-redhat-linux/7${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}} \
    LIBRARY_PATH=/opt/rh/devtoolset-7/root/usr/lib64:/opt/rh/devtoolset-7/root/usr/lib/gcc/x86_64-redhat-linux/7${LD_LIBRARY_PATH:+:${LIBRARY_PATH}} \
    PKG_CONFIG_PATH=/opt/rh/devtoolset-7/root/usr/lib64/pkgconfig${PKG_CONFIG_PATH:+:${PKG_CONFIG_PATH}} \
